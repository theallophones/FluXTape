...
<!-- Spectrum Analyzer -->
<canvas id="spectrum" width="600" height="120"
        style="display:block; margin:20px auto; background:transparent;"></canvas>
...
<div style="text-align:center; margin-top:20px;">
  <input id="volumeSlider" type="range" min="0" max="1" step="0.01" value="1" style="width:220px;">
</div>
...
<script>
  ...
  ws.backend.setFilters([analyser]);
